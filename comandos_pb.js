...
// Seleciona o botão pelo ID da TAG 
...
botao_baixar.addEventListener('click', function() {
    ...
    const texto_pb01_coluna = document.getElementById('texto_pb01'); // Vincula à tag <label id="texto_er01">
    // Seleciona o elemento <input> pelo ID
    const anomalias_pb01_1 = document.getElementById('anomalias_pb01'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    //const nqm01 = document.getElementById('nqm_q1_pb01'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const nqm_q3 = document.getElementById('nqm_q3_pb01'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_in = document.getElementById('desvios_internos_pb01'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_for = document.getElementById('desvios_fornecedor_pb01'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const ordens_produzidas = document.getElementById('ordens_produzidas_pb01'); // Vincula à tag <input id="anomalias_er01">
    ...
    // Seleciona o elemento <label> pelo ID
    const texto_pb02_coluna = document.getElementById('texto_pb02'); // Vincula à tag <label id="texto_er01">
    // Seleciona o elemento <input> pelo ID
    const anomalias_2 = document.getElementById('anomalias_pb02'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    //const nqm01_2 = document.getElementById('nqm_q1_pb02'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const nqm_q3_2 = document.getElementById('nqm_q3_pb02'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_in_2 = document.getElementById('desvios_internos_pb02'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_for_2 = document.getElementById('desvios_fornecedor_pb02'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const ordens_produzidas_2 = document.getElementById('ordens_produzidas_pb02'); // Vincula à tag <input id="anomalias_er01">
    //#############################################################################################    
    ...
    const texto_pb02_pc_coluna = document.getElementById('texto_pb02_pc'); // Vincula à tag <label id="texto_er01">
    // Seleciona o elemento <input> pelo ID
    const anomalias_3 = document.getElementById('anomalias_pb02_pc'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    //const nqm01_3 = document.getElementById('nqm_q1_pb02_pc'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const nqm_q3_3 = document.getElementById('nqm_q3_pb02_pc'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_in_3 = document.getElementById('desvios_internos_pb02_pc'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_for_3 = document.getElementById('desvios_fornecedor_pb02_pc'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const ordens_produzidas_3 = document.getElementById('ordens_produzidas_pb02_pc'); // Vincula à tag <input id="anomalias_er01">
    ...
    const texto_pb03_coluna = document.getElementById('texto_pb03'); // Vincula à tag <label id="texto_er01">
    // Seleciona o elemento <input> pelo ID
    const anomalias_4 = document.getElementById('anomalias_pb03'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    //const nqm01_4 = document.getElementById('nqm_q1_pb03'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const nqm_q3_4 = document.getElementById('nqm_q3_pb03'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_in_4 = document.getElementById('desvios_internos_pb03'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_for_4 = document.getElementById('desvios_fornecedor_pb03'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const ordens_produzidas_4 = document.getElementById('ordens_produzidas_pb03'); // Vincula à tag <input id="anomalias_er01">
    ...
    // Seleciona o elemento <label> pelo ID
    const texto_pb04_coluna = document.getElementById('texto_pb04'); // Vincula à tag <label id="texto_er01">
    // Seleciona o elemento <input> pelo ID
    const anomalias_5 = document.getElementById('anomalias_pb04'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    //const nqm01_5 = document.getElementById('nqm_q1_pb04'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const nqm_q3_5 = document.getElementById('nqm_q3_pb04'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_in_5 = document.getElementById('desvios_internos_pb04'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_for_5 = document.getElementById('desvios_fornecedor_pb04'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const ordens_produzidas_5 = document.getElementById('ordens_produzidas_pb04'); // Vincula à tag <input id="anomalias_er01">
    //#############################################################################################   
    ...
    // Seleciona o elemento <label> pelo ID
    const texto_maq_db_travessa_coluna = document.getElementById('texto_maq_db_travessa'); // Vincula à tag <label id="texto_er01">
    // Seleciona o elemento <input> pelo ID
    const anomalias_6 = document.getElementById('anomalias_maq_db_travessa'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    //const nqm01_6 = document.getElementById('nqm_q1_maq_db_travessa'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const nqm_q3_6 = document.getElementById('nqm_q3_maq_db_travessa'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_in_6 = document.getElementById('desvios_internos_maq_db_travessa'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_for_6 = document.getElementById('desvios_fornecedor_maq_db_travessa'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const ordens_produzidas_6 = document.getElementById('ordens_produzidas_maq_db_travessa'); // Vincula à tag <input id="anomalias_er01">
    //#############################################################################################   
    ...
    // Seleciona o elemento <label> pelo ID
    const texto_maq_eb_coluna = document.getElementById('texto_maq_eb'); // Vincula à tag <label id="texto_er01">
    // Seleciona o elemento <input> pelo ID
    const anomalias_7 = document.getElementById('anomalias_maq_eb'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    //const nqm01_7 = document.getElementById('nqm_q1_maq_eb'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const nqm_q3_7 = document.getElementById('nqm_q3_maq_eb'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_in_7 = document.getElementById('desvios_internos_maq_eb'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const desvios_for_7 = document.getElementById('desvios_fornecedor_maq_eb'); // Vincula à tag <input id="anomalias_er01">
    // Seleciona o elemento <input> pelo ID
    const ordens_produzidas_7 = document.getElementById('ordens_produzidas_maq_eb'); // Vincula à tag <input id="anomalias_er01">
    //#############################################################################################  
    ...
    // Seleciona o elemento <input> pelo ID
        ...
        // Seleciona o elemento <label> pelo ID
        const texto_maq_bs_coluna = document.getElementById('texto_maq_bs'); // Vincula à tag <label id="texto_er01">
        // Seleciona o elemento <input> pelo ID
        const anomalias_8 = document.getElementById('anomalias_maq_bs'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
//        const nqm01_8 = document.getElementById('nqm_q1_maq_bs'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const nqm_q3_8 = document.getElementById('nqm_q3_maq_bs'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_in_8 = document.getElementById('desvios_internos_maq_bs'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_for_8 = document.getElementById('desvios_fornecedor_maq_bs'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const ordens_produzidas_8 = document.getElementById('ordens_produzidas_maq_bs'); // Vincula à tag <input id="anomalias_er01">
//#############################################################################################  
...
// lógica para baixar o excel, selecionado as tags para copiar linha 9
    // Seleciona o elemento <input> pelo ID
        ...
        // Seleciona o elemento <label> pelo ID
        const texto_maq_estampa_bat_coluna = document.getElementById('texto_maq_estampa_bat'); // Vincula à tag <label id="texto_er01">
        // Seleciona o elemento <input> pelo ID
        const anomalias_9 = document.getElementById('anomalias_maq_estampa_bat'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
//        const nqm01_9 = document.getElementById('nqm_q1_maq_estampa_bat'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const nqm_q3_9 = document.getElementById('nqm_q3_maq_estampa_bat'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_in_9 = document.getElementById('desvios_internos_maq_estampa_bat'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_for_9 = document.getElementById('desvios_fornecedor_maq_estampa_bat'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const ordens_produzidas_9 = document.getElementById('ordens_produzidas_maq_estampa_bat'); // Vincula à tag <input id="anomalias_er01">
//#############################################################################################  
...
// lógica para baixar o excel, selecionado as tags para copiar linha 10
    // Seleciona o elemento <input> pelo ID
        ...
        // Seleciona o elemento <label> pelo ID
        const texto_maq_estampa_trav_coluna = document.getElementById('texto_maq_estampa_trav'); // Vincula à tag <label id="texto_er01">
        // Seleciona o elemento <input> pelo ID
        const anomalias_10 = document.getElementById('anomalias_maq_estampa_trav'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
//        const nqm01_10 = document.getElementById('nqm_q1_maq_estampa_trav'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const nqm_q3_10 = document.getElementById('nqm_q3_maq_estampa_trav'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_in_10 = document.getElementById('desvios_internos_maq_estampa_trav'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_for_10 = document.getElementById('desvios_fornecedor_maq_estampa_trav'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const ordens_produzidas_10 = document.getElementById('ordens_produzidas_maq_estampa_trav'); // Vincula à tag <input id="anomalias_er01">
//#############################################################################################  
...
// lógica para baixar o excel, selecionado as tags para copiar linha 11
    // Seleciona o elemento <input> pelo ID
        ...
        // Seleciona o elemento <label> pelo ID
        const texto_maq_estampa_port_coluna = document.getElementById('texto_maq_estampa_port'); // Vincula à tag <label id="texto_er01">
        // Seleciona o elemento <input> pelo ID
        const anomalias_11 = document.getElementById('anomalias_maq_estampa_port'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
//        const nqm01_11 = document.getElementById('nqm_q1_maq_estampa_port'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const nqm_q3_11 = document.getElementById('nqm_q3_maq_estampa_port'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_in_11 = document.getElementById('desvios_internos_maq_estampa_port'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_for_11 = document.getElementById('desvios_fornecedor_maq_estampa_port'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const ordens_produzidas_11 = document.getElementById('ordens_produzidas_maq_estampa_port'); // Vincula à tag <input id="anomalias_er01">
//#######################################################################################################################  
//-------------------------------------------------------------------------------------------------------------------------- TAGS OK
...
// lógica para baixar o excel, selecionado as tags para copiar linha 12
    // Seleciona o elemento <input> pelo ID
        ...
        // Seleciona o elemento <label> pelo ID
        const texto_maq_estampa_toeguard_coluna = document.getElementById('texto_maq_estampa_toeguard'); // Vincula à tag <label id="texto_er01">
        // Seleciona o elemento <input> pelo ID
        const anomalias_12 = document.getElementById('anomalias_maq_estampa_toeguard'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
//        const nqm01_12 = document.getElementById('nqm_q1_maq_estampa_toeguard'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const nqm_q3_12 = document.getElementById('nqm_q3_maq_estampa_toeguard'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_in_12 = document.getElementById('desvios_internos_maq_estampa_toeguard'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const desvios_for_12 = document.getElementById('desvios_fornecedor_maq_estampa_toeguard'); // Vincula à tag <input id="anomalias_er01">
        // Seleciona o elemento <input> pelo ID
        const ordens_produzidas_12 = document.getElementById('ordens_produzidas_maq_estampa_toeguard'); // Vincula à tag <input id="anomalias_er01">
//#######################################################################################################################  
//
...
// Obtém o conteúdo das tags linha 1 *******************************************************************
    ...
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_pb01_coluna  = texto_pb01_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
    const conteudo_anomalias_pb01 = parseFloat(anomalias_pb01_1.value); // Converte o valor para número
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 2 -----------------------------------------------------------------------
    ...
    const conteudo_texto_pb02_coluna = texto_pb02_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
    const conteudo_anomalias_pb02 = parseFloat(anomalias_2.value); // Converte o valor para número
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 3 -----------------------------------------------------------------------
    ...
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_pb02_pc_coluna = texto_pb02_pc_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 4 -----------------------------------------------------------------------
    ...
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_pb03_coluna = texto_pb03_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 5 -----------------------------------------------------------------------
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_pb04_coluna = texto_pb04_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 6 -----------------------------------------------------------------------
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_maq_db_travessa_coluna = texto_maq_db_travessa_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 7 -----------------------------------------------------------------------
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_maq_eb_coluna = texto_maq_eb_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 8 -----------------------------------------------------------------------
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_maq_bs_coluna = texto_maq_bs_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 9 -----------------------------------------------------------------------
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_maq_estampa_bat_coluna = texto_maq_estampa_bat_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 10 -----------------------------------------------------------------------
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_maq_estampa_trav_coluna = texto_maq_estampa_trav_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
// Obtém o conteúdo das tags linha 11 -----------------------------------------------------------------------
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_maq_estampa_port_coluna = texto_maq_estampa_port_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
//#####################################################################################################
    ...
    // Obtém o conteúdo do elemento <label>
    const conteudo_texto_maq_estampa_toeguard_coluna = texto_maq_estampa_toeguard_coluna.textContent; // Pega o texto dentro da tag <label>
    // Obtém o valor do elemento <input>
...
var resultado_conteudo_anomalias_pb01 = conteudo_anomalias_pb01 * 10; // Multiplica o valor da variável por 10
...
var resultado_multiplicados = resultado_conteudo_anomalias_pb01 + //resultado_conteudo_nqm01 + 
...
var resultado_conteudo_anomalias_2= conteudo_anomalias_pb02 * 10; // Multiplica o valor da variável por 10
...
// Somando os resultados
var resultado_multiplicados_12 = resultado_conteudo_anomalias_12 + //resultado_conteudo_nqm01_11 + 
...
XLSX.utils.sheet_add_aoa(worksheet, [
    [conteudo_nsemana, conteudo_texto_pb01_coluna, conteudo_anomalias_pb01, //conteudo_nqm01, 
        conteudo_nqm_q3, 
...
XLSX.utils.sheet_add_aoa(worksheet, [
    [conteudo_nsemana2, conteudo_texto_pb02_coluna, conteudo_anomalias_pb02, //conteudo_nqm01_2, 
        conteudo_nqm_q3_2, 
...
XLSX.utils.sheet_add_aoa(worksheet, [
    [conteudo_nsemana3, conteudo_texto_pb02_pc_coluna, conteudo_anomalias_3, //conteudo_nqm01_3, 
        conteudo_nqm_q3_3, 
...
// Resultados 4° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
    [conteudo_nsemana, conteudo_texto_pb03_coluna, conteudo_anomalias_4, //conteudo_nqm01_4, 
        conteudo_nqm_q3_4, 
...
// Resultados 5° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
[conteudo_nsemana, conteudo_texto_pb04_coluna, conteudo_anomalias_5, //conteudo_nqm01_5, 
    conteudo_nqm_q3_5, 
...
// Resultados 6° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
[conteudo_nsemana, conteudo_texto_maq_db_travessa_coluna, conteudo_anomalias_6, //conteudo_nqm01_6, 
    conteudo_nqm_q3_6, 
...
// Resultados 7° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
[conteudo_nsemana, conteudo_texto_maq_eb_coluna, conteudo_anomalias_7, //conteudo_nqm01_7, 
    conteudo_nqm_q3_7, 
...
// Resultados 8° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
[conteudo_nsemana, conteudo_texto_maq_bs_coluna, conteudo_anomalias_8, //conteudo_nqm01_8, 
    conteudo_nqm_q3_8, 
...
// Resultados 9° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
[conteudo_nsemana, conteudo_texto_maq_estampa_bat_coluna, conteudo_anomalias_9, //conteudo_nqm01_9, 
    conteudo_nqm_q3_9, 
...
// Resultados 10° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
[conteudo_nsemana, conteudo_texto_maq_estampa_trav_coluna, conteudo_anomalias_10, //conteudo_nqm01_10, 
    conteudo_nqm_q3_10, 
...
// Resultados 11° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
[conteudo_nsemana, conteudo_texto_maq_estampa_port_coluna, conteudo_anomalias_11, //conteudo_nqm01_11, 
    conteudo_nqm_q3_11, 
...
// Resultados 12° linha 
XLSX.utils.sheet_add_aoa(worksheet, [
    [conteudo_nsemana, conteudo_texto_maq_estampa_toeguard_coluna, conteudo_anomalias_12, //conteudo_nqm01_12, 
        conteudo_nqm_q3_12, 
...
link.download = 'Relatório não conformidades PB.xlsx'; // Nome do arquivo que será baixado
...
var subject = `Resumo Semana ${conteudo_nsemana} - Qualidade PB`; // Define o assunto do email
...
}); // Fecha a função do botão "Enviar e baixar arquivo"
...
}); // Fecha a função do botão voltar
